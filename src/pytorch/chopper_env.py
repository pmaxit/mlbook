...
class ChopperScope(Env):
    def __init__(self):
        ...
        self.y_min = int (self.observation_shape[0] * 0.1)  # 60
        self.x_min = 0                                      # 0
        self.y_max = int (self.observation_shape[0] * 0.9)  # 540
        self.x_max = self.observation_shape[1]              # 800
